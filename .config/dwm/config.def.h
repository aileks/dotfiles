...
static const char *const autostart[] = {
    ...
    "feh",
    "--bg-scale",
    "$HOME/Art/ボイラブ/912ae5dc93bc270d3851fb5f4b3cd2e7.png",
    NULL,
    NULL /* terminate */
};
...
static const char *dmenucmd[] = {
    "rofi",  "-show",        "combi",           "-modes",
    "combi", "-combi-modes", "window,drun,run", NULL};
...
static const Key keys[] = {
    ...
    TAGKEYS(XK_1, 0) TAGKEYS(XK_2, 1) TAGKEYS(XK_3, 2) TAGKEYS(XK_4, 3)
        TAGKEYS(XK_5, 4) TAGKEYS(XK_6, 5) TAGKEYS(XK_7, 6) TAGKEYS(XK_8, 7)
            TAGKEYS(XK_9, 8){MODKEY | ShiftMask, XK_q, spawn,
                             SHCMD("$HOME/.config/scripts/rofi-power.sh")},
