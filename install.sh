...
packages=(
  ...
  docker docker-compose 7zip tree bat eza psmisc fd fzf git jq shfmt ripgrep sqlite trash-cli unzip wget xdotool rsync zip
  zoxide nvme-cli btop fastfetch curl github-cli xorg-server xinit xauth xorg-apps xf86-input-libinput slop xkeyboard-config
  alsa-pipewire pipewire libspa-bluetooth wireplumber-elogind pulseaudio-utils j4-dmenu-desktop maim xclip xss-lock clipmenu
  ...
  ncurses-devel gpu-screen-recorder
)
