...
packages=(
  ...
  docker docker-compose 7zip tree bat eza psmisc fd fzf git jq shfmt ripgrep sqlite trash-cli unzip gsettings-desktop-schemas
  ...
  ncurses-devel gpu-screen-recorder firefox
)
