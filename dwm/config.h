...
static const Layout layouts[] = {
    {"[]=",
     flextile,
     {-1, -1, SPLIT_VERTICAL, TOP_TO_BOTTOM, TOP_TO_BOTTOM, 0, NULL}},
    {"><>", NULL, {0}},
    {"[M]", flextile, {-1, -1, NO_SPLIT, MONOCLE, MONOCLE, 0, NULL}},
    {"TTT",
     flextile,
     {-1, -1, SPLIT_HORIZONTAL, LEFT_TO_RIGHT, LEFT_TO_RIGHT, 0, NULL}},
    {"|M|",
     flextile,
    ...
    {"[D]",
     flextile,
     {-1, -1, SPLIT_VERTICAL, TOP_TO_BOTTOM, MONOCLE, 0, NULL}},
...
static const char *powercmd[] = {"/bin/sh", "-c", "$HOME/.local/bin/rofi-power",
                                 NULL};
...
static const Key keys[] = {
    ...
    TAGKEYS(XK_1, 0) TAGKEYS(XK_2, 1) TAGKEYS(XK_3, 2) TAGKEYS(XK_4, 3)
        TAGKEYS(XK_5, 4) TAGKEYS(XK_6, 5) TAGKEYS(XK_7, 6) TAGKEYS(XK_8, 7)
            TAGKEYS(XK_9, 8){0, XF86XK_AudioMute, spawn,
    ...
    {ShiftMask, XK_Print, spawn,
     SHCMD("$HOME/.local/bin/screenshot area file")},
    {ControlMask, XK_Print, spawn,
     SHCMD("$HOME/.local/bin/screenshot window clipboard")},
    {ControlMask | ShiftMask, XK_Print, spawn,
     SHCMD("$HOME/.local/bin/screenshot window file")},
    {MODKEY, XK_Print, spawn,
     SHCMD("$HOME/.local/bin/screenshot fullscreen clipboard")},
    {MODKEY | ShiftMask, XK_Print, spawn,
     SHCMD("$HOME/.local/bin/screenshot fullscreen file")},

    /* Screen recording */
    {0, XK_F9, spawn, SHCMD("$HOME/.local/bin/screenrecord area")},
    {ShiftMask, XK_F9, spawn, SHCMD("$HOME/.local/bin/screenrecord window")},
    {ControlMask, XK_F9, spawn,
     SHCMD("$HOME/.local/bin/screenrecord fullscreen")},
};
