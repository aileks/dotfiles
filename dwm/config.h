...
#if BAR_PANGO_PATCH
static const char font[]                 = "AdwaitaMono Nerd Font Mono 16";
#else
static const char *fonts[]               = { "AdwaitaMono Nerd Font Mono:size=16" };
#endif
static const char dmenufont[]            = "AdwaitaMono Nerd Font Mono:size=16";
