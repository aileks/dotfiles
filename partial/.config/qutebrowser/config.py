...
c.colors.completion.even.bg = "#1e1815"
...
c.colors.tabs.pinned.odd.bg = "#271e1a"
c.colors.tabs.pinned.even.bg = "#271e1a"
...
c.colors.statusbar.private.bg = "#271e1a"
c.colors.statusbar.private.fg = accent
c.colors.statusbar.command.private.bg = "#271e1a"
...
c.colors.statusbar.url.success.https.fg = bright
